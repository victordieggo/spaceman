...
<head>
    ...
    <title>Spaceman Framework 1.8.4</title>
        ...
        <div class="bg-darker">
            <div class="row text-white">
                <div class="col-12 pad-05 align-center no-spacer">
                    <p><small>© 2015 Spaceman 1.8.4 Framework. Desenvolvido por <a class="no-underline" href="">V.</a></small>
                    </p>
                </div>
            </div>
        </div>
